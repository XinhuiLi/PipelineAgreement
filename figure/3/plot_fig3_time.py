    ...
    for row in range(nrow):
        ...
        for num, pl in enumerate(pipelist):
            ...
            for ses in range(1,4):
                ...
                if row == nrow-1:
                    axs[row, (ses-1)].set_xticks([x_grid[0], x_grid[int(0.6*binnum)], x_grid[int(0.8*binnum)], x_grid[int(0.9*binnum)], x_grid[binnum-1]])
                    axs[row, (ses-1)].set_xticklabels(['0', '0.6', '0.8', '0.9', '1'])
