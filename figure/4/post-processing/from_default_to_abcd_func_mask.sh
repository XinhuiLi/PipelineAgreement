...
cd /data3/cnl/xli/reproducibility/out/source_of_var/from_default_to_abcd/func_mask_v2
ln /data3/cnl/fmriprep/Lei_working/CPAC_XCP/ABCD/preprocessed/data/sub-0025448/ses-1/files/MNINonLinear/Results/task-rest01/brainmask_fs.2.0.nii.gz /data3/cnl/xli/reproducibility/out/cpac_abcd/working/cpac_sub-0025448a_ses-1/resample_anat_brain_mask_in_standard_125/wmparc_maths_fill_holes_maths_warp_warp_warp.nii.gz
...
for ((subid=27;subid<57;subid++));do
    ...
    abcd_func_mask=/data3/cnl/xli/reproducibility/out/cpac_abcd/working/cpac_sub-00254${subid}a_ses-1/resample_anat_brain_mask_in_standard_125/wmparc_maths_fill_holes_maths_warp_warp_warp.nii.gz
...
mask=/data3/cnl/fmriprep/Lei_working/Finalizing/Schaefer_Atlas/Schaefer2018_200Parcels_7Networks_order_FSLMNI152_3mm.nii.gz
out_path=/data3/cnl/xli/reproducibility/out/source_of_var/from_default_to_abcd/func_mask_v2
data_path=/data3/cnl/xli/reproducibility/analysis/data/from_default_to_abcd/func_mask_v2
roi_path=/data3/cnl/xli/reproducibility/analysis/ROI200/from_default_to_abcd/func_mask_v2
